...
feature "Director edits a category" do
  ...
  background do
    sign_in director
    visit edit_director_category_path(category)
  end
...
feature "Director views category index" do
  ...
  scenario "with no categories" do
    visit director_categories_path
...
feature "Director deletes a category" do
  ...
  background do
    sign_in director
    visit director_category_path(category)
  end
  ...
  scenario "successfully" do
    ...
    expect(page).to have_notice_message
    expect(page).to have_title "Eat Halal | Categories"
    expect(page).to_not have_link category.id, href: edit_director_category_path(category)
